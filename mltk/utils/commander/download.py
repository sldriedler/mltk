...
DOWNLOAD_URLS = {
    'windows': dict( 
        url='https://github.com/sldriedler/mltk_assets/raw/master/tools/commander/Commander_win32_x64_1v12p0b1057.zip',
        subdir='v1.12',
        sha1='17C6D488A92979AA8F17C436D150A1F9A6F1694B'
    ),
    'linux': dict( 
        url='https://github.com/sldriedler/mltk_assets/raw/master/tools/commander/Commander_linux_x86_64_1v12p0b1057.tar.bz',
        subdir='v1.12',
