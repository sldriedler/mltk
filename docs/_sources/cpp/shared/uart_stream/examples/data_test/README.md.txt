...
See the source code for this example on Github: [cpp/shared/uart_stream/examples/data_test](https://github.com/sldriedler/mltk/blob/master/cpp/shared/uart_stream/examples/data_test)
