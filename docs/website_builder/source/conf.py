...
html_theme_options = {
    ...
    'heroes': {
        ...
        'docs/modeling': 'The MLTK provides numerous features to aid the development of ML models',
        'docs/model_profiler': 'Profile a model to determine how efficiently it may execute on hardware',
        'docs/model_visualizer' : 'Visualize a model using an interactive webpage',
        'docs/model_specification': 'Define a model specification using a standard Python script',
        'docs/model_training': 'Train an ML model using Google Tensorflow',
        'docs/model_evaluation': 'Evaluate an ML model to determine how accurate it is',
        'docs/model_quantization': 'Quantize a model to reduce its memory footprint',
        'docs/model_parameters': 'Embed custom parameters into the generated model file',
        'docs/model_summary': 'Generate a textual summary of a model',
        'docs/model_archive': 'All model development files are store in a distributable archive',
        'docs/model_search_path': 'Specify the model search path',
    },
    'nav_links': [
        {
            'href': 'https://docs.silabs.com/gecko-platform/latest/machine_learning/tensorflow/overview',
            'internal': False,
